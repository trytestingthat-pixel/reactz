...
const LocationSection = () => {
  ...
  const handleGetDirections = () => {
    window.open(
      "https://maps.google.com/?q=Nasir+Tower+2,Dhaka,Bangladesh",
      "_blank"
    );
  };
      ...
      <div className="location-container">
        ...
        <div className="location-header">
          ...
          <p className="location-subtitle">
            Strategically situated at Nasir Tower 2 for maximum convenience and
            accessibility
          </p>
        </div>
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <div className="feature-content">
                  <h4>Premium Tower</h4>
                  <p>
                    Modern commercial space with state-of-the-art facilities
                  </p>
                </div>
              </div>
              ...
              <div className="feature-card">
                <div className="feature-icon">
                  <img
                    src="https://cdn-icons-png.flaticon.com/512/2088/2088573.png"
                    alt="Security"
                  />
                </div>
                <div className="feature-content">
